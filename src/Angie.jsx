...
export default function Angie(){
  ...
  // El progreso se calcula a partir del identificador de cada pregunta. Así, al
  // corregir la ubicación de una pregunta, sus intentos y aciertos la acompañan
  // al tema correcto sin perderse ni duplicarse en el porcentaje mostrado.
