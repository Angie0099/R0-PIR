...
if (!manifest.subjects[CHILD]) throw new Error("La primera publicación infantil no está presente.");
if (!baseChild.every((question) => reviewed.has(question.v))) throw new Error("La publicación infantil previa contiene preguntas no revisadas.");
...
if (invalidLocations.length) throw new Error("Las preguntas a mover no aparecen exactamente una vez: " + invalidLocations.join(", "));
