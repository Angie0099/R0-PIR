...
const block = bank.filter(q => q.t?.includes(topic)).slice(60, 100);
...
console.log('Tercer bloque reauditorado: 40 preguntas correctas, sin reubicaciones ni duplicados exactos.');
